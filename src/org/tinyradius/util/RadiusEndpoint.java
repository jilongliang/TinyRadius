...
/**
 * This class stores information about a Radius endpoint. This includes the
 * address of the remote endpoint and the shared secret used for securing the
 * communication.
 */
public class RadiusEndpoint {
	 ...
	 * 
	 * @param remoteAddress
	 *            remote address (ip and port number)
	 * @param sharedSecret
	 *            shared secret
	 */

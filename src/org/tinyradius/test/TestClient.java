...
public class TestClient {
	...
	public static void main(String[] arg) throws Exception {
		...
		String args [] = new String[] {"192.168.1.102","secretKey001","test001","123456"};
		...
		if (rc.authenticate(user, pass)) {
			...
			System.out.println("sharedSecret="+rc.getSharedSecret());
		}
		...
		System.out.println(response.getAuthenticator().toString());

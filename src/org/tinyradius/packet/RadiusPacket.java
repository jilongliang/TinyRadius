...
public class RadiusPacket {
	 ...
	 * Vendor-Specific sub-attributes. If a attribute with a vendor code != -1 is
	 * passed in, a VendorSpecificAttribute is created for the sub-attribute.
	 * 
	 * @param attribute
	...
	/**
	 * Returns all attributes of this packet that have got the given type and belong
	 * to the given vendor ID. Returns an empty list if there are no such
	 * attributes.
	 * 
	 * @param vendorId
	 *            vendor ID
	...
	/**
	 * Returns a Radius attribute of the given type which may only occur once in the
	 * Radius packet.
	 * 
	 * @param type
	 *            attribute type
	 ...
	 *             if there are multiple occurences of the requested attribute type
	 */
	...
	/**
	 * Returns the value of the Radius attribute of the given type or null if there
	 * is no such attribute. Also returns sub-attributes.
	 * 
	 * @param type
	 *            attribute type name
	...
	/**
	 * Returns the Vendor-Specific attribute for the given vendor ID. If there is
	 * more than one Vendor-Specific attribute with the given vendor ID, the first
	 * attribute found is returned. If there is no such attribute, null is returned.
	 * 
	 * @param vendorId
	...
	/**
	 * Creates a RadiusPacket object. Depending on the passed type, the appropiate
	 * successor is chosen. Sets the type, but does not touch the packet identifier.
	 * 
	 * @param type
	 *            packet type
	...
	/**
	 * Returns the authenticator for this Radius packet. For a Radius packet read
	 * from a stream, this will return the authenticator sent by the server. For a
	 * new Radius packet to be sent, this will return the authenticator created by
	 * the method createAuthenticator() and will return null if no authenticator has
	 * been created yet.
	 * 
	...
	/**
	 * Sets the authenticator to be used for this Radius packet. This method should
	 * seldomly be used. Authenticators are created and managed by this class
	 * internally.
	 * 
	 * @param authenticator
	 *            authenticator
	 ...
	 *            shared secret to be used to encode this packet
	 * @param request
	 *            Radius request packet if this packet to be encoded is a response
	 *            packet, null if this packet is a request packet
	 * @exception IOException
	 *                communication error
	...
	/**
	 * This method exists for subclasses to be overridden in order to encode packet
	 * attributes like the User-Password attribute. The method may use
	 ...
	 * 
	 * @param sharedSecret
	 *            shared secret that secures the communication with the other Radius
	 *            server/client
	...
	/**
	 * AccountingRequest overrides this method to create a request authenticator as
	 * specified by RFC 2866.
	 * 
	 * @param sharedSecret
	 *            shared secret
	 * @param packetLength
	...
	/**
	 * Reads a Radius packet from the given input stream and creates an appropiate
	 * RadiusPacket descendant object. Reads in all attributes and returns the
	 * object. Decodes the encrypted fields and attributes of the packet.
	 * 
	 * @param dictionary
	 *            dictionary to use for attributes
	 * @param sharedSecret
	 *            shared secret to be used to decode this packet
	 * @param request
	 *            Radius request packet if this is a response packet to be decoded,
	 *            null if this is a request packet to be decoded
	 * @return new RadiusPacket object
	 * @exception IOException
	 ...
	 * This method may use getAuthenticator() to get the request authenticator.
	 * 
	 * @param sharedSecret
	 */
	...
	/**
	 * This method checks the authenticator of this Radius packet. This method may
	 * be overriden to include special attributes in the authenticator check.
	 * 
	 * @param sharedSecret

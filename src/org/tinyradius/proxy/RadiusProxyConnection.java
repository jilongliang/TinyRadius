...
/**
 * This class stores information about a proxied packet. It contains two
 * RadiusEndpoint objects representing the Radius client and server, the port
 * number the proxied packet arrived at originally and the proxied packet
 * itself.
 */
public class RadiusProxyConnection {
	 ...
	 *            client endpoint
	 * @param port
	 *            port the proxied packet arrived at originally
	 */
